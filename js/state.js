...
const ACHIEVEMENTS = [
  ...
  { id: 'triple_supernova', category: 'w2', name: 'Drievoudige Supernova', icon: '☀️', desc: 'Behaal ooit een score van minstens 50.000 in Wereld 1 Endless, in Wereld 2 Endless èn in Hardcore-modus — dus in alle drie deze categorieën apart een topscore van 50.000, niet allemaal in hetzelfde potje.', reward: { type: 'skin', skinId: 'supernova' }, check: () => highScore >= 50000 && highScoreWorld2 >= 50000 && highScoreHardcore >= 50000 },
