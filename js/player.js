...
const SPECIAL_BOT_TYPES = [
  ...
  { name: 'vexer',      minScore: 700, minLevel: 9,  r: 17, hp: 9,  speed: [1.0, 1.4], cooldown: [1800, 2200], pattern: 'curse',         bulletSpeed: 0, specialDmg: 0,  color: () => `hsl(${Math.floor(Math.random()*15)+320}, 60%, 40%)` },
