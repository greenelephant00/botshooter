...
const SPECIAL_BOT_TYPES = [
  ...
  { name: 'miasma',     minScore: 700, minLevel: 9,  r: 18, hp: 10, speed: [0.9, 1.3], cooldown: [2800, 3400], pattern: 'gascloud',      bulletSpeed: 0, specialDmg: 9,  color: () => `hsl(${Math.floor(Math.random()*15)+100}, 65%, 40%)` },
