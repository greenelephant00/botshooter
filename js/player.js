...
const SPECIAL_BOT_TYPES = [
  ...
  { name: 'cryostasis', minScore: 700, minLevel: 9,  r: 18, hp: 10, speed: [0.9, 1.3], cooldown: [5200, 6000], pattern: 'freezetrap',    bulletSpeed: 0, specialDmg: 8,  color: () => `hsl(${Math.floor(Math.random()*15)+195}, 75%, 60%)` },
