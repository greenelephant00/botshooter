...
const SPECIAL_BOT_TYPES = [
  ...
  { name: 'railgunner', minScore: 700, minLevel: 9,  r: 20, hp: 10, speed: [0.5, 0.8], cooldown: [2400, 2800], pattern: 'snipebeam',     bulletSpeed: 0, specialDmg: 42, color: () => `hsl(${Math.floor(Math.random()*15)+5}, 80%, 45%)` },
